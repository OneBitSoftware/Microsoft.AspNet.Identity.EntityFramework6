namespace Microsoft.AspNet.Identity.EntityFramework6
{
    ...
    public class RoleStore<TRole> : RoleStore<TRole, IdentityDbContext, string>
        ...
        where TContext : DbContext
    {
        ...
        public async Task<IList<Claim>> GetClaimsAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var roleClaims = await RoleClaims.Where(rc => rc.RoleId.Equals(roleId)).ToListAsync(cancellationToken);
        ...
        public Task AddClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var roleId = ConvertIdToString(role.Id);
            RoleClaims.Add(new IdentityRoleClaim
            {
                RoleId = roleId,
        ...
        public async Task RemoveClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var roleId = ConvertIdToString(role.Id);
            var claims = await RoleClaims.Where(rc => rc.RoleId.Equals(roleId)
                            && rc.ClaimValue == claim.Value && rc.ClaimType == claim.Type)
